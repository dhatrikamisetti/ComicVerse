...
document.addEventListener('DOMContentLoaded', function() {
  const itemList = document.getElementById('movies');
  ...
  searchButton.addEventListener('click', () => {
      ...
      if (searchTerm) {
          ...
          alert("Please enter an movie name to search.");
      }
  });
  ...
  async function fetchmovies(searchTerm = '') {
      ...
      let url = `https://comicvine.gamespot.com/api/movies/?format=json&offset=${offset}&api_key=${API_KEY}&field_list=name,image,api_detail_url`;
