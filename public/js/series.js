...
document.addEventListener('DOMContentLoaded', function() {
  const itemList = document.getElementById('series');
  ...
  searchButton.addEventListener('click', () => {
      ...
      if (searchTerm) {
          ...
          alert("Please enter an series name to search.");
      }
  });
  ...
  async function fetchseries(searchTerm = '') {
      ...
      let url = `https://comicvine.gamespot.com/api/series_list/?format=json&offset=${offset}&api_key=${API_KEY}&field_list=name,image,api_detail_url`;
      ...
      try {
          ...
          alert('Failed to fetch series. Please try again later.');
      } finally {
